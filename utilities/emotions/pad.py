...
emotion_look_up = {
    "happy": torch.tensor([0.80, 0.60, 0.50], dtype=torch.float32),
    "sad": torch.tensor([-0.70, -0.50, -0.40], dtype=torch.float32),
    "angry": torch.tensor([-0.60, 0.70, 0.60], dtype=torch.float32),
    "fearful": torch.tensor([-0.75, 0.70, -0.50], dtype=torch.float32),
    "surprised": torch.tensor([0.50, 0.80, 0.40], dtype=torch.float32),
    "disgusted": torch.tensor([-0.60, 0.50, 0.50], dtype=torch.float32),
    "neutral": torch.tensor([0.0, 0.0, 0.0], dtype=torch.float32),
    "tender": torch.tensor([0.70, 0.40, 0.40], dtype=torch.float32),
    "excited": torch.tensor([0.70, 0.75, 0.60], dtype=torch.float32),
    "confused": torch.tensor([-0.20, 0.30, -0.10], dtype=torch.float32),
    "pleased": torch.tensor([0.90, 0.70, 0.60], dtype=torch.float32),
    "satisfied": torch.tensor([0.85, 0.65, 0.55], dtype=torch.float32),
    "bored": torch.tensor([-0.30, -0.20, -0.10], dtype=torch.float32),
}
